    ...
    <form action="{{route('stocks.store')}}" method="post">
        ...
        <div class="card">
            <div class="col-md-8 col-sm-6 form-group">
                ...
                <select class="form-data" name="category" id="category" required>
            ...
            <div class="col-md-8 col-sm-6 form-group">
                ...
                <select class="form-data" name="material" id="material" required>
            ...
            if (categoryId) {
                @foreach ($materials as $material)
                    if ({{ $material->category_id }} == categoryId) {
                        var materialOption = $('<option>').text("{{ $material->material_name }}").val("{{ $material->id }}");
